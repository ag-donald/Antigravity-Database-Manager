...
# ==============================================================================
def main() -> None:
    """Five-phase recovery pipeline: preflight → discover → backup → inject → report."""
